...
class CPOTrainer(Trainer):
    ...
    def __init__(
        ...
        self.relax_cofficient_1 = args.relax_cofficient_1
        self.relax_cofficient_2 = args.relax_cofficient_2
        self.aux_loss_enabled = getattr(model.config, "output_router_logits", False)
        self.average_log_prob = self.loss_type in ["ipo", "simpo"]
    ...
    def cpo_loss(
        ...
        Args:
            ...
            num_non_pad_tokens: The number of non-pad tokens in each example in the batch. Shape: (batch_size,)
        ...
        penalty = torch.abs((policy_chosen_logps / num_non_pad_tokens[
                                                   :len_chosen] - policy_rejected_logps / num_non_pad_tokens[
                                                                                          len_chosen:]))
    ...
    def concatenated_forward(
        ...
        num_non_pad_tokens = (concatenated_batch["concatenated_labels"] != self.label_pad_token_id).sum(-1)
